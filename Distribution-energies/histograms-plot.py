...
###############33descomentar para graficas los histogramas con a libreria de astronomia
    ...
    ax.hist(y, 5000, density=True, color='k')
    ...
    ax.hist(x1, 5000, density=True, color='k')
    ...
    ax.text(0.95, 0.80, ('$\mu_1 = {:.3f}$\n $\sigma_1={:.3f}$\n $T={}$'.format(sample_mu,sample_std,te)),
        transform=ax.transAxes, ha='right', va='top')
    plt.savefig("Interaction-energy-histogram-N=20-T{}.png".format(te))
    plt.show()
    plt.close()
